package cn.sunjl.admin.log.aspect;
...
import cn.sunjl.admin.log.event.SysLogEvent;
import cn.sunjl.admin.log.util.LogUtil;
...
public class SysLogAspect {
     ...
     */
    @Pointcut("@annotation(cn.sunjl.admin.log.annotation.SysLog)")
