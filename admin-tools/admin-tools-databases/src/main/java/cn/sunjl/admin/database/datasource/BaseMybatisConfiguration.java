package cn.sunjl.admin.database.datasource;


import cn.sunjl.admin.base.id.IdGenerate;
import cn.sunjl.admin.base.id.SnowflakeIdGenerate;
import cn.sunjl.admin.database.mybatis.typehandler.FullLikeTypeHandler;
import cn.sunjl.admin.database.mybatis.typehandler.LeftLikeTypeHandler;
import cn.sunjl.admin.database.mybatis.typehandler.RightLikeTypeHandler;
import cn.sunjl.admin.database.parsers.TenantWebMvcConfigurer;
...
public abstract class BaseMybatisConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(name = "admin.database.isMultiTenant", havingValue = "true", matchIfMissing = true)
