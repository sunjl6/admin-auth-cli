package cn.sunjl.admin.database.properties;
...
import static cn.sunjl.admin.database.properties.DatabaseProperties.PREFIX;
...
public class DatabaseProperties {
    public static final String PREFIX = "admin.database";
    /**
     * 攻击 SQL 阻断解析器
     */
     ...
     * 事务扫描基础包
     */
    private String transactionScanPackage = "cn.sunjl.admin";
}
